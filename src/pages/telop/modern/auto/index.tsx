...
import { ModernAutoCommunityCards } from "./components/CommunityCards";
import { ModernAutoPlayerCards } from "./components/PlayerCards";
...
export function TelopModernAutoPage({ board, players }: Props) {
  const {
    size,
    playersLeft,
    playersRight,
