...
import { ClassicAutoCommunityCards } from "./components/CommunityCards";
import { ClassicAutoPlayerCards } from "./components/PlayerCards";
...
export function TelopClassicAutoPage({ board, players }: Props) {
  const {
    size,
    playersLeft,
    playersRight,
