...
import { BroadcastAutoCommunityCards } from "./components/CommunityCards";
import { BroadcastAutoPlayerCards } from "./components/PlayerCards";
...
export function TelopBroadcastAutoPage({ board, players }: Props) {
  const {
    size,
    playersLeft,
    playersRight,
